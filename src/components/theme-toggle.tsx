...
import { Moon, Sun, Monitor, Palette, Check, Plus } from "lucide-react"
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-5 gap-2">
                    ...
                    {/* Custom Color Picker */}
                    <label className="group relative w-8 h-8 rounded-full flex items-center justify-center transition-transform hover:scale-110 border border-white/10 cursor-pointer overflow-hidden" title="Custom Color">
                      <div className="absolute inset-0 bg-gradient-to-br from-violet-500 via-fuchsia-500 to-orange-500 opacity-80 group-hover:opacity-100 transition-opacity" />
                      <input
                        type="color"
