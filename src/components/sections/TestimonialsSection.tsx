...
const testimonials = [
    {
        ...
        company: "TechCorp",
        avatar: "SC",
        quote: "AutoForge ML cut our model deployment time from weeks to hours. The AI code generation is incredibly accurate.",
        rating: 5
    },
    {
        ...
        company: "DataFlow",
        avatar: "JR",
        quote: "Finally, a platform that understands what ML engineers actually need. The VS Code integration is seamless.",
        rating: 5
    },
    {
        name: "Emily Watson",
        ...
        company: "StartupAI",
        avatar: "EW",
        quote: "We went from prototype to production in a single day. The multi-cloud training options are game-changing.",
        rating: 5
    },
    {
        name: "Michael Park",
        ...
        company: "AILabs",
        avatar: "MP",
        quote: "The model registry and version control saved us countless hours of debugging. Highly recommended.",
        rating: 5
    },
]

// Hexagon grid pattern component
            ...
            <svg width="100%" height="100%" className="absolute inset-0">
                <defs>
                    <pattern id="hexagons" width="56" height="100" patternUnits="userSpaceOnUse" patternTransform="scale(2)">
                        <path
                            d="M28 0 L56 16.7 L56 50 L28 66.7 L0 50 L0 16.7 Z M28 100 L56 116.7 L56 150 L28 166.7 L0 150 L0 116.7 Z"
                            fill="none"
                            stroke={themeColor}
                            strokeWidth="0.5"
                        />
    ...
    return (
        <section className="relative z-20 py-24 px-6 md:px-12 lg:px-16 xl:px-20 overflow-hidden">
            ...
            <div
                ...
                style={{
                    background: `radial-gradient(ellipse at center, ${themeColor}40, transparent 60%)`
                }}
            />
            ...
            <div className="max-w-6xl mx-auto relative">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-black mb-4">
                        ...
                        <span style={{ color: themeColor }}>Engineers</span>
                    </h2>
                ...
                {/* Testimonials Grid - Better card styling */}
                        ...
                        >
                            ...
                            {i === activeIndex && (
                                <div
                                    ...
                                    style={{
                                        background: `radial-gradient(circle at top right, ${themeColor}40, transparent 60%)`
                                    }}
                                />
                            )}
                            ...
                            <Quote
                                ...
                                style={{ color: i === activeIndex ? themeColor : 'white' }}
                            />
