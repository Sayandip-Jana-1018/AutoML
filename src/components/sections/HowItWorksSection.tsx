    ...
    const steps = [
        {
            ...
            description: "Upload CSV, JSON, or Excel files. AI auto-detects columns, data types, and suggests target variables.",
            icon: Database
        },
        {
            step: "02",
            title: "Train with AI",
            description: "Choose ML algorithms (RandomForest, XGBoost, etc.) or let AutoML find the best model. Train on GCP or GPU.",
            icon: Cpu
        },
        {
            step: "03",
            title: "Deploy Instantly",
            description: "One-click deployment to production. Get REST API endpoints with automatic scaling and version control.",
            icon: Rocket
        },
        {
            step: "04",
            title: "Collaborate",
            description: "Share projects with teammates. Real-time VS Code sync, model marketplace, and version history.",
            icon: Users
        },
        {
            step: "05",
            title: "Iterate & Improve",
            description: "Use AI Chat to refine scripts, retrain models, and track metrics. Continuous improvement made easy.",
            icon: RefreshCw
        }
    ]
